package com.haozhi.common.util;
...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "haozhi";
    ...
    public static String aesDecode(String content) {
        try {
            ...
            throw new RuntimeException("兄弟，配置文件中的密码需要使用AES加密，请使用com.zheng.AESUtil 工具类修改这些值！");
            //e.printStackTrace();
        } catch (BadPaddingException e) {
            e.printStackTrace();
        }
